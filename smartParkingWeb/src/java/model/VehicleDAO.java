...
public class VehicleDAO {
    ...
    public static boolean editVehicle(int idvehicle, String plate, int userid, String model, String imgFile,
            String description) {
    ...
    public static ArrayList<Vehicle> getListPendingVehicle() {
        ArrayList<Vehicle> listVehicle = new ArrayList<Vehicle>();

        try {
            DbConnect connect = new DbConnect();
            String query = "Select id, plate, model, img, status, description from vehicle where status ='pending'";
            ...
            System.out.println("Error getListVehicle: " + e.getMessage());
        }
    ...
    // ArrayList<Vehicle> listvehicle = getListPendingVehicle();
