                    ...
                    <form action="adAddStaff" method="POST">
                        <div class="table-bordered well">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="fullname" placeholder="Ex: Phan Văn A"
                                    required="required">
                            </div>
                            <div class="input-group">
                    ...
                    <tbody>
                        <c:forEach var="staff" items="${listStaff}">
                            <tr>
                                ...
                                <td> <a href="#deactive" data-toggle="modal" class="btn btn-danger btnSetstatus ${staff.getStatus()=="
                                        deactive"? "hide" :""}">Deactive</a>
                                    <a href="#active" data-toggle="modal" class="btn btn-primary btnSetstatus ${staff.getStatus()=="
                                        deactive"? "" :"hide"}">Active</a>
                                    <input name="idStaff" class="hide" value="${staff.getId()}">
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
