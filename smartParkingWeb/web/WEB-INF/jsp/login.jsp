            ...
            <div id="signup" class="signupTab tab-pane fade">
                <form action="" id="registerUserForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="su-username" placeholder="Username" required="required"
                            name="username">
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" id="su-email" placeholder="Email" required="required"
                            name="email">
                    </div>
                    <div class="form-group">
                        <label>Password</label>
                        <input type="password" class="form-control" id="su-password" placeholder="Password" required="required"
                            name="password">
                    </div>
                    <div class="form-group">
                        <label>Full Name</label>
                        <input type="text" class="form-control" id="su-fullname" placeholder="Fullname" required="required"
                            name="fullname">
                    </div>
                    <div class="form-group">
                        <label>Phone number</label>
                        <input type="number" min='0' class="form-control" id="su-phone" placeholder="Phone number"
                ...
                <form action="${pageContext.request.contextPath}/login/loginForm" method="POST" role="form">
                    ...
                    <div class="radioBtn row col-md-12">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <label class="radio-inline"><input type="radio" name="accountType" checked="checked" value="user">Login
                                As User</label>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <label class="radio-inline"><input type="radio" name="accountType" value="staff">Login As
                                Staff</label>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="lo-username" placeholder="Your username" required="required"
                            name="username">
                    </div>
                    <div class="form-group">
                        <label for="">Password</label>
                        <input type="password" class="form-control" id="lo-password" placeholder="Password" required="required"
                            name="password">
                    </div>
                    <br>
