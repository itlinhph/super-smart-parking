            ...
            <ul class="nav navbar-nav navbar-right navbar-collapse collapse navCollapse">
                ...
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> My Account<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a class="glyphicon glyphicon-tag" href="${pageContext.request.contextPath}/ticket/manageTiket"> Ticket History</a></li>
                        <li><a class="glyphicon glyphicon glyphicon-bed" href="${pageContext.request.contextPath}/vehicle/userVehiclePage"> Manage Vehicle</a></li>
                        <li><a class="glyphicon glyphicon-cog" href="${pageContext.request.contextPath}/user/userInfor"> Personal Setting</a></li>
                        <li><a class="glyphicon glyphicon glyphicon-info-sign" href="${pageContext.request.contextPath}/park/userParkInfor"> Parking Infor</a></li>
