...
<div class="col-xs-3 col-sm-2 col-md-3 col-lg-3 well navLeft">
    ...
    <ul class="nav nav-pills nav-stacked selectCategoryMenu">
        ...
        <li id="parkmenu" class="selectCategory"> <a href="${pageContext.request.contextPath}/user/parking" class="glyphicon glyphicon glyphicon-info-sign cName"> Parking Information</a></li>
