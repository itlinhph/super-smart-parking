                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4">
                            ...
                            <div class="table-bordered">
                                <img src="${pageContext.request.contextPath}/resources/images/plate/${wrongPlate.getImg()}"
                        ...
                        <div class="col-sm-6 col-md-7 col-lg-7 ">
                            <div class="table-bordered well">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="plate" value="${wrongPlate.getDetectedPlate()}"
                                        required="required">
                                </div>
                                <br>
