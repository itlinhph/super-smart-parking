                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6 ">
                                    <div class="table-bordered vehicleDescription well">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" disabled value="${report.getStatus()==null?"
                                                Not Submit":report.getStatus()}">
                                        </div>
                                        <div class="input-group">
                                            <span class="input-group-addon label-vehicle">Type</span>
                                            <select id="selectType" class="form-control" name="type" required
                                                ${report.getStatus()=="processed" ?"disabled":""}>
                                        ...
                                        <div class="form-group">
                                            <label>Detail</label>
                                            <br>
                                            <textarea class="descriptionReport" name="description" ${report.getStatus()=="processed"
                                                ?"disabled":""} placeholder="Description" required="required">${report.getDescription()}</textarea>
                                        </div>

                                        <br>
                                        <div class="row">
                                            <div class="col-md-6 ">
                                                <button type="submit" class="btn btn-info ${report.getStatus()=="
                                                    processed"?"hide":""}">Submit</button>
                                            </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6 ">
                                    <div class="form-group">
                                        ...
                                        <br><br>
                                        <div class=" ${report.getStatus()==" processed"?"":"hide"}" name="adminNote"
                                            placeholder="">ADMIN: ${report.getAdminNote()}</div>
                                    </div>
                                </div>
                            </div>
