                                    ...
                                    <div class="col-sm-6 col-md-7 col-lg-7 ">
                                        <div class="table-bordered vehicleDescription well">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" ${vehicle.getStatus()=="working"
                                                    ?"disabled":""} name="plate" value="${vehicle.getPlate()}" required="required">
                                            </div>
                                            <div class="input-group">
                                                <span class="input-group-addon label-vehicle">Model</span>
                                                <input type="text" class="form-control" name="model" value="${vehicle.getModel()}"
                                                    ${vehicle.getStatus()=="working" ?"disabled":""} required="required">
                                            </div>

                                            <div class="form-group">
                                                <label>Description</label>
                                                <br>
                                                <textarea class="descriptionVehicle" name="description"
                                                    ${vehicle.getStatus()=="working" ?"disabled":""} placeholder="Description"
                                                    required="required">${vehicle.getDescription()}</textarea>
                                            </div>
                ...
                <div id="addVehicle" class="hide">
                    <form role="form" method="POST" action="addVehicle">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4">
                                <div class="table-bordered productPreview">
                                    <img src="${pageContext.request.contextPath}/resources/images/defaultImage.jpg" alt=""
                                        class="img-display table-bordered img-responsive">
                                    <div class="row">
                                        <br><br>
                                        <div class="col-md-12">
                                            <div class="form-group">
                            ...
                            <div class="col-sm-6 col-md-7 col-lg-7 ">
                                <div class="table-bordered vehicleDescription well">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon label-vehicle">Plate</span>
                                        <input type="text" class="form-control" name="plate" placeholder="Ex: 29S2-12345"
                                            required="required">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon label-vehicle">Model</span>
                                        <input type="text" class="form-control" name="model" placeholder="Ex: SH Mode 125"
                                            required="required">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Description</label>
                                        <br>
                                        <textarea class="descriptionVehicle" name="description" placeholder="Description"
